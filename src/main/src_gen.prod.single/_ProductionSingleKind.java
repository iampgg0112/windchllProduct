...
public abstract class _ProductionSingleKind extends EnumeratedType {
    ...
    static final String CLASS_RESOURCE = "com.prod.single.ProductionSingleKindRB";
    ...
    static EnumeratedType[] initializeLocaleSet(Locale locale) throws Throwable {
        return instantiateSet(ProductionSingleKind.class.getMethod("newProductionSingleKind", Integer.TYPE), "com.prod.single.ProductionSingleKindRB", locale);
    }
}
