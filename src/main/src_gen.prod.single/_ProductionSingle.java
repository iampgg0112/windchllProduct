...
import com.prod.single.ProductionSingle;
import com.prod.single.ProductionSingleKind;
...
public abstract class _ProductionSingle extends WTObject implements Typed, ContentHolder, Ownable, Foldered, DomainAdministered, WTContained, LifeCycleManaged, Externalizable {
    static final long serialVersionUID = 1L;
    static final String RESOURCE = "com.prod.single.singleResource";
    ...
    public static final long EXTERNALIZATION_VERSION_UID = 4645270065931695434L;
    ...
    public Number getNumberOfBackups() {
        return this.numberOfBackups;
    }

    public void setNumberOfBackups(Number numberOfBackups) throws WTPropertyVetoException {
        this.numberOfBackupsValidate(numberOfBackups);
        this.numberOfBackups = numberOfBackups;
    }

    void numberOfBackupsValidate(Number numberOfBackups) throws WTPropertyVetoException {
        ...
        } else if (numberOfBackups != null && numberOfBackups.floatValue() > 60.0F) {
    ...
    public void writeExternal(ObjectOutput output) throws IOException {
        output.writeLong(4645270065931695434L);
    ...
    public void writeExternal(PersistentStoreIfc output) throws SQLException, DatastoreException {
        ...
        output.setObject("numberOfBackups", this.numberOfBackups);
    ...
    public void readExternal(PersistentRetrieveIfc input) throws SQLException, DatastoreException {
        ...
        this.numberOfBackups = (Number)input.getObject("numberOfBackups");
    ...
    boolean readVersion4645270065931695434L(ObjectInput input, long readSerialVersionUID, boolean superDone) throws IOException, ClassNotFoundException {
        if (!superDone) {
            super.readExternal(input);
        }
        ...
        this.numberOfBackups = (Number)input.readObject();
    ...
    protected boolean readVersion(ProductionSingle thisObject, ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone) throws IOException, ClassNotFoundException {
        ...
        if (readSerialVersionUID == 4645270065931695434L) {
            return this.readVersion4645270065931695434L(input, readSerialVersionUID, superDone);
        } else {
    ...
    boolean readOldVersion(ObjectInput input, long readSerialVersionUID, boolean passThrough, boolean superDone) throws IOException, ClassNotFoundException {
        throw new InvalidClassException(CLASSNAME, "Local class not compatible: stream classdesc externalizationVersionUID=" + readSerialVersionUID + " local class externalizationVersionUID=" + 4645270065931695434L);
    }
}
